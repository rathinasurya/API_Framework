...
public class CreateProjectUsingSelenium {
	@Test
	public void createProject() throws SQLException {
		...
		driver.findElement(By.xpath("//input[@name='projectName']")).sendKeys("NewAPIProject6");
		...
		String id = driver.findElement(By.xpath("//td[.='NewAPIProject6']/../td[1]")).getText();
